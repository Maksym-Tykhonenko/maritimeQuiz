...
import {topick7} from '../../data/topick7';
...
const Lvls7 = ({navigation, route}) => {
  ...
  const [usedHintsForCurrentQuestion, setUsedHintsForCurrentQuestion] =
    useState(false);
  //console.log('topickLength==>', topick7.length);
  ...
  useEffect(() => {
    if (currentQuestionIndex < 10) {
      const currentQuestion = topick7[currentQuestionIndex];
      setOptions(
  ...
  return (
    <View
      ...
      {currentQuestionIndex >= topick7.length ? (
        <View
          style={{
            flex: 1,
            alignItems: 'center',
        ...
        <View style={{paddingHorizontal: 10}}>
          ...
          <ScrollView>
            <Image
              source={require('../../assets/Stage2/T7.png')}
