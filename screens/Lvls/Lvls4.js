...
import {topick4} from '../../data/topick4';
...
const Lvls4 = ({navigation, route}) => {
  ...
  const [usedHintsForCurrentQuestion, setUsedHintsForCurrentQuestion] =
    useState(false);
  //console.log('topickLength==>', topick4.length);
  ...
  useEffect(() => {
    if (currentQuestionIndex < 10) {
      const currentQuestion = topick4[currentQuestionIndex];
      setOptions(
  ...
  return (
    <View
      ...
      {currentQuestionIndex >= topick4.length ? (
        <View
          style={{
            flex: 1,
            alignItems: 'center',
        ...
        <View style={{paddingHorizontal: 10}}>
          ...
          <ScrollView>
            <Image
              source={require('../../assets/Stage2/T4.png')}
